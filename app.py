...
dates2IBCCA.loc[-1] = [max(dates2IBCCA["DOW"]) + np.timedelta64(7, 'D')]
...
dates2AEPCCA.loc[-1] = [max(dates2AEPCCA["DOW"]) + np.timedelta64(7, 'D')]
...
dates2CCA.loc[-1] = [max(dates2CCA["DOW"]) + np.timedelta64(7, 'D')] ##############################
