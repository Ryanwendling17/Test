...
newMedia3 = {'Title': 'What We\'re Listening to This Week', 'Details': 'More or Less: Behind the Stats is led by Tim Hartford through BBC Radio 4 and aims to explain (and sometimes disprove) common statistics in the news and in politics. Advanced statistics knowledge is not required to keep up with the topics and Hartford does a great job of coaching the audience to be critical of common numbers attached to narratives we hear. In this episode, he speaks with Michael Hobbes and reintroduces the concept of “Zombie Statistics”, (statistics that are proven wrong but are still commonly cited) as they relate to a QAnon campaign about child trafficking.'}
...
html.H4(Media.iloc[0, 0], style={'font-size': '16pt'}),
        ...
        html.Img(id='WhatAnEconLooksLike', src='https://kulogo.s3.us-east-2.amazonaws.com/Monica_Garcia-Perez.jpg', style={'width': '33%', 'float': 'left', 'margin-top': '10px'}),
        ...
        html.Iframe(height="200px", width="100%",  src="https://www.bbc.co.uk/sounds/play/p09166w4"),
